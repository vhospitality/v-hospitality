export class CaretEvent {
  ...
  clone(): CaretEvent {
    return new CaretEvent(
      Object.assign({}, this, {
        caretRange:
          this.caretRange && this.caretRange.cloneRange
            ? this.caretRange.cloneRange()
            : this.caretRange,
      })
    );
  }
  ...
  static comparePropsOfObject(r1: any, r2: any) {
    for (let k in r1) {
      if (r1[k] !== r2[k]) {
        return false;
      }
