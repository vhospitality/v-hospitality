  ...
  datas: any = [
      ...
      content: [
        {
          ...
          content: [
            {
              name: 'This Privacy Policy outlines how ("Vefristay") collects, uses, shares, and protects user information.',
            },
          ],
        },
      ],
    ...
    //
    {
      ...
      content: [
...

        {
          ...
          content: [
            {
              name: "Vefristay collects device information, IP addresses, and usage data for analytics and security purposes.",
            },
          ],
        },
      ],
    ...
    //
    {
      ...
      content: [
        {
          title:
            "Vefristay employs industry-standard security measures to protect user information.",
          content: [
            {
      ...
      content: [
        {
          ...
          content: [
            {
              name: "Vefristay uses cookies and similar technologies to enhance user experience and collect analytics data.",
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          content: [
            {
              name: "Users can manage communication preferences, review and update personal information, and adjust privacy settings through Vefristay.",
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          content: [
            {
              name: "Vefristay is not intended for individuals under the age of 18. Parents or guardians should monitor and control the use of Vefristay by minors.",
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          content: [
            {
              name: "Users will be notified of any changes to the Privacy Policy. Continued use of Vefristay after such changes constitutes acceptance of the updated policy.",
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          content: [
            {
              name: "For privacy-related inquiries or concerns, users can contact Vefristay's Data Protection Officer at [admin2@vefristay.com].",
            },
          ],
        },
      ],
